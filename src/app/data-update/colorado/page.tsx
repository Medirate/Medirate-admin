...
export default function ColoradoDataUpdate() {
  return (
        ...
        <div className="w-64 bg-white shadow-lg min-h-screen">
          <div className="p-6">
            ...
            <nav className="space-y-1 max-h-96 overflow-y-auto">
              ...
              <Link href="/data-update/colorado" className="flex items-center px-4 py-3 text-white bg-[#012C61] rounded-lg">
                <FaMap className="mr-3" />
                Colorado
              </Link>
        ...
        <div className="flex-1 p-4 sm:p-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
          ...
          <div className="flex items-center mb-6 sm:mb-8">
            ...
            <h1 className="text-xl sm:text-3xl md:text-4xl text-[#012C61] font-lemonMilkRegular uppercase">
              Colorado Data Update
            </h1>
          </div>

          <p className="text-lg text-gray-600 mb-8">Manage and update data for Colorado.</p>

          {/* Empty content area */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="text-center py-12">
              <FaDatabase className="h-16 w-16 text-gray-300 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-500 mb-2">Colorado Data Update</h3>
