...
export default function CaliforniaDataUpdate() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="flex">
        ...
        <div className="w-64 bg-white shadow-lg min-h-screen">
          <div className="p-6">
            ...
            <nav className="space-y-1 max-h-96 overflow-y-auto">
              ...
              <Link href="/data-update/california" className="flex items-center px-4 py-3 text-white bg-[#012C61] rounded-lg">
                <FaDatabase className="mr-3" />
                California
              </Link>
        ...
        <div className="flex-1 p-4 sm:p-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
          ...
          <p className="text-lg text-gray-600 mb-8">Manage and update data for California.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Upload new data files for California.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Download current data for California.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Check synchronization status for California.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#012C61]">25,432</p>
              </div>
              <div className="p-3 bg-blue-100 rounded-lg">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#012C61]">1h ago</p>
              </div>
              <div className="p-3 bg-green-100 rounded-lg">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#012C61]">12</p>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#012C61]">99%</p>
              </div>
              <div className="p-3 bg-purple-100 rounded-lg">
          ...
          {/* Data Table */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">California Data Records</h3>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#CA001</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kaiser Permanente</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$185.50</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#CA002</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Blue Shield CA</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$142.75</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#CA003</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Anthem Blue Cross</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$198.25</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                        Active
                      </span>
