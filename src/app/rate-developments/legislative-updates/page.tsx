...
import { FaExclamationTriangle, FaArrowLeft, FaPlus, FaEdit, FaTrash, FaCheckCircle, FaClock, FaFileAlt, FaDatabase, FaEnvelope, FaBell } from 'react-icons/fa';
        ...
        <div className="w-64 bg-white shadow-lg min-h-screen">
          <div className="p-6">
            ...
            <nav className="space-y-2">
              ...
              <Link href="/rate-developments/legislative-updates" className="flex items-center px-4 py-3 text-white bg-[#012C61] rounded-lg">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">Medicaid Provider Enrollment Bill</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">Provider Reimbursement Policy Changes</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                      FL
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-07-15</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">Mental Health Services Expansion Act</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-07-10</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                      Published
                    </span>
